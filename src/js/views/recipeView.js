...
// I COULD export the entire class and create an instance i the controller. But I don't want more than one single instance.
    ...
    return `
      <li class="recipe__ingredient">
        ...
        <div class="recipe__quantity">${
          ingredient.quantity
            ? fracty(ingredient.quantity) //? new Fraction(ingredient.quantity).toString()
            : ''
        }</div>
